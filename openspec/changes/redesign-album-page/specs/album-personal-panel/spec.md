...
Panel "Tu relación" de la página de álbum: presenta el estado personal del usuario sobre
el álbum (valoración, reseña, escuchas, favorito, pendiente, colección, búsqueda y listas)
como estado accionable, en lugar de una columna de botones sueltos.
