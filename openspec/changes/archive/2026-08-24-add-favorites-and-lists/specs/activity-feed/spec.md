# activity-feed Delta Specification

## Purpose

Ampliación del feed v1 de Fase 5: además de las escuchas del diario, el feed pasa a incluir
favoritos y listas publicadas, manteniendo la paginación, el cálculo bajo demanda y las reglas
de audiencia y bloqueos existentes.
