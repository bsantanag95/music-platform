...
Créditos de personal de un álbum (intérpretes, producción, sonido, arte y otros) tomados de
las relaciones de MusicBrainz a nivel edición y grabación, su ingesta sin requests extra,
su clasificación en niveles y su sincronización para álbumes existentes.
