...
Resumen de todas las ediciones de un álbum en MusicBrainz — sello, número de catálogo,
formato, país, estado y cantidad de pistas —, su ingesta paginada y sincronización, y la
detección de variantes con pistas adicionales cuya lista se ingiere bajo demanda.
