...
Dirección propia para cada reseña: una página completa en `/{locale}/review/{id}` y su
presentación como modal cuando se abre desde el índice de reseñas de un álbum.
