...
Permite al dueño destacar un máximo de valoraciones propias (de artista, álbum o canción) para su perfil. Es la primera excepción deliberada a la regla de que las valoraciones solo las ven el dueño y sus seguidores aceptados: una valoración destacada es visible para cualquier visitante. Cubre fijar y quitar el destacado, el tope y la sección "Valoraciones destacadas" del perfil.
