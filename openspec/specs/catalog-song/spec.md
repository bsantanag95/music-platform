...
Define la página de detalle de canción como una superficie **deliberadamente mínima**
(cambio `rebalance-catalog-detail-pages`, Fase 1 de `redefine-content-hierarchy`): la
canción es entidad real pero la inversión rica va al álbum. La página lidera con el o los
álbumes que contienen la canción; la expresión primaria es la **reacción cualitativa** del
diario, con las **estrellas** degradadas a un control secundario detrás de una divulgación;
muestra la **reacción agregada pública** de la comunidad y el **historial de escuchas
propio**; los créditos completos y las ediciones quedan en una ficha técnica plegada. No
hay bloque de reseñas.
