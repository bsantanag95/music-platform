...
Preferencia opcional de audiencia por defecto del contenido nuevo de biblioteca (favoritos, entradas de diario, listas y copias de colección): su precedencia al crear, su carácter no retroactivo, su alcance (no cubre reseñas ni comentarios, que son públicos) y su control en la pantalla Privacidad y audiencia de los ajustes.
