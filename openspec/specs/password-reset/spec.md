...
Restablecimiento de contraseña por email para cuentas con contraseña local: pedido con respuesta
genérica anti-enumeración, token de un solo uso, definición de una contraseña nueva y cierre de todas
las sesiones. El envío de correo pasa por un transporte desacoplado (adaptador de desarrollo y
proveedor real configurable).

## Purpose

Permitir que una persona que olvidó su contraseña recupere el acceso sin intervención manual, sin
revelar si un email tiene cuenta y sin habilitar vinculación implícita por email (ADR 0014). El flujo
funciona en desarrollo con el adaptador `console` y falla cerrado en producción sin proveedor real.
