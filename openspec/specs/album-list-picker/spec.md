# album-list-picker Specification

## Purpose
Permitir, desde el panel "Tu relación" del álbum, ver en qué listas y Caminos propios está el álbum y agregarlo o quitarlo con casillas, con búsqueda y alcance sobre todas las listas del usuario.
## Requirements
