# profile-album-identity Specification

## Purpose

Define la sección **"Álbumes favoritos"** del perfil: hasta 6 álbumes que el dueño fija
manualmente como declaración de identidad cultural, encima de los destacados mixtos. Un
álbum favorito fijado es un `favorite` de álbum propio (borrado en cascada = desfijado); la
sección no ordena por métrica, no muestra posiciones ni estrellas, y respeta la audiencia
del favorito subyacente.
