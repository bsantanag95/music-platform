# profile-in-rotation Specification

## Purpose

Define la sección **"En rotación"** del perfil: qué ha estado escuchando esta persona
últimamente, derivado **exclusivamente** del diario (`listen_entry`, últimos 30 días) —
nunca de valoraciones, favoritos ni reseñas. El cálculo se modela como
`señales → score → estado` sobre eventos crudos de escucha (pesos discretos de recencia,
