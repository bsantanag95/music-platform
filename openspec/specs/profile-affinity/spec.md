# profile-affinity Specification

## Purpose
Coincidencias entre el visitante autenticado y el dueño del perfil: favoritos en común, entidades que ambos puntúan alto, y seguidores en común. Fase 5, cambio redesign-user-profile.
## Requirements
