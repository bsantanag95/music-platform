...
Vitrina pública de actividad de la comunidad en `/{locale}/activity`, accesible con y sin
sesión, enlazada desde la barra general del Header. Sin sesión muestra una única fuente
("Recientes"); con sesión, tres fuentes como pestañas ("Recientes", "De la gente que
seguís", "Tu actividad"), cada una paginada de forma independiente.
