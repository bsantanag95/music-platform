# taste-fingerprint Specification

## Purpose
Retrato de gusto del perfil filtrado por audiencia: distribución de valoraciones, décadas y géneros presentes, y reparto por tipo de entidad, con equivalente textual accesible. Fase 5, cambio redesign-user-profile.
## Requirements
