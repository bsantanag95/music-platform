# artist-following Specification

## Purpose

Define la relación unilateral **usuario → artista** (`artist_follow`, cambio
`add-artist-following`, Fase 2 de `redefine-content-hierarchy`), separada del seguimiento
usuario → usuario. Seguir es inmediato y sin aprobación; seguir y dejar de seguir son
operaciones idempotentes que no crean favoritos ni valoraciones. En esta fase la relación
es señal de **afinidad, descubrimiento y organización personal**: el botón de seguir en la
