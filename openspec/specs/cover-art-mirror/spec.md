...
Espejo propio de las carátulas de Cover Art Archive en baja resolución (WebP de 250 px), bajo demanda, cuando hay storage configurado y contacto de retiro de carátulas, con revalidación, retiro a pedido, backfill y reversión.
