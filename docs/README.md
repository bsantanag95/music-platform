...
| `05-features/` | Especificaciones de producto por feature (catálogo, valoraciones, diario de escucha, listas, feed) — ver su propio índice en `05-features/README.md` | 🟡 Fases 3 y 4 implementadas; Fase 5: social base + diario propio + diario visible en perfiles + feed v1 implementados |
