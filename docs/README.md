...
| `02-architecture/frontend-plan/` | Plan de implementación del frontend (Fase 3): análisis de backend, arquitectura de frontend, etapas, buenas prácticas y riesgos — ver su propio índice en `frontend-plan/README.md` | 🟢 Bloqueantes resueltos, lista para Etapa 3.4 |
