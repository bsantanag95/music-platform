...
| `02-architecture/auth.md` | Diseño operativo de autenticación local, sesiones e identidades externas | ✅ Autenticación local, Google OAuth, recuperación de contraseña y verificación de email implementados |
| `02-architecture/adr/` | Registro de decisiones de arquitectura, una por archivo (0001-pwa-vs-nativa, 0002-postgresql-vs-nosql, 0003-uuid-vs-autoincremental, 0004-modelo-credit-colaboraciones, 0005-orm-drizzle-migraciones-sql, 0006-rest-vs-trpc, 0007-i18n-next-intl, 0008-auth-sesiones-y-hash-contrasena, 0009-borrado-fisico-rating-comment, 0010-identidades-externas-y-proveedores-oauth, 0011-idempotencia-y-concurrencia-en-ingestion-del-catalogo, 0012-roles-moderacion-y-suspension-social, 0013-rol-editorial-y-autoria-de-listas, 0014-recuperacion-contrasena-y-transporte-email, 0015-verificacion-de-email, 0016-vinculacion-explicita-de-google-y-autenticacion-reciente, 0017-imagenes-propias-y-storage) | ✅ |
| `02-architecture/data-classification.md` | Clasificación de los datos por perdibilidad/reconstruibilidad: fuente de verdad propia, espejo de MusicBrainz, derivada, efímera | ✅ |
...
| `05-features/` | Especificaciones de producto por feature (catálogo, valoraciones, diario de escucha, listas, feed) — ver su propio índice en `05-features/README.md` | 🟡 Fases 3 y 4 implementadas; Fase 5: privacidad, seguimiento, diario, favoritos y listas y feed v1 implementados; scrobbling pendiente |
| `06-operations/backup-restore.md` | Operación de backup y restore de la base de datos local, con prueba real de restauración (item A.7 del checklist de infraestructura) | ✅ Backup nocturno + prueba de restore real (2026-08-31); PITR diferido |
