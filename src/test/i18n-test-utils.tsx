...
const messagesByLocale = {
  es: { common: commonEs, catalog: catalogEs, errors: errorsEs, auth: authEs, users: usersEs },
  en: { common: commonEn, catalog: catalogEn, errors: errorsEn, auth: authEn, users: usersEn },
};
