...
// lee como el lomo de una funda, no como un recuadro vacío. Calcada de
// `want-to-listen/ArtistPlate`, con tamaño y tipografía parametrizables para
// reusarse en los tres modos de visualización.
