...
// add-feed-kind-differentiation, "seguir artista" en
// add-artist-follow-feed-entry): el tratamiento minimizado del tier 4 —sumar a
// la colección—, agrupado por autor, una línea por grupo. De-enfatizada
// respecto del listado cronológico: encabezado chico, texto `font-data`
// muted, sin carátula. Colapsa entera si no hay eventos.
