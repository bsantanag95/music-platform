...
interface PublicListsProps {
  ...
  // Muestra el disco de vinilo a la izquierda de cada tarjeta (los eventos de
  // lista no tienen carátula de álbum).
  withCover?: boolean;
}
...
export async function PublicLists({ entries, withCover = false }: PublicListsProps) {
